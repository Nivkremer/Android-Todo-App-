...
public class MyTodoContentProvider extends ContentProvider {
  ...
  private static final String AUTHORITY = "com.sciatic.todo.contentprovider";
  ...
  public Cursor query(Uri uri, String[] projection, String selection,
     ...
     * 
     This is the exact same as below.
    	...
    	Cursor cursor = db.query(TodoTable.TABLE_TODO, projection, selection,
    ...
    */
     ...
     * This is must have in order to promiss that any listener such as 
     * loader is attached to the content resolver will be invoked  */
